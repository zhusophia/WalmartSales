...
salesstorep <- ggplot(data=salesstore, aes(x=Store, y=Weekly_Sales), fill=Store) +
  geom_bar(stat="identity", fill="#414288", aes(text = paste0(
    "Store Number: ", Store,
    "<br>",
...
We can also see how sales varied from month to month. 
...
salesyearp <-ggplot(data=salesyear, aes(x=Date, y=Weekly_Sales/1000000, group=1)) +
  geom_line(colour = "#414288")+
  geom_point(aes(text = paste0(
    "Date: ", Date,
    "<br>",
    "Monthly Sales (Millions): ", round(Weekly_Sales/1000000, digits=3)))) + 
