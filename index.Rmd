...
This project focuses on analyzing raw data from [this dataset](https://www.kaggle.com/datasets/mikhail1681/walmart-sales?resource=download), which tracks the weekly sales of 45 Walmart stores over 2 years. It also records external variables like whether the week contained a holiday, the CPI, and the unemployment rate of the region.        
...
### Point-Biserial correlation coefficient supports previous analysis
