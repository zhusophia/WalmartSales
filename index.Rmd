...
tempsalesp <- ggplot(data=tempandsales, aes(x=Temperature, y=Weekly_Sales)) +
  geom_point(color="#0071CE", aes(text = paste0(
    "Average Weekly Sales (Millions): ", round(Weekly_Sales, digits=3)))) + 
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) + 
...
knitr::kable(data.frame(Date = c("2024/04", "2024/01", "2023/09", "2023/05", "2023/01", "2022/09","2022/05", "2022/01"),
             ...
             "Fuel Prices" =c(169.76, 145.9, 162.45, 160.62, 153.48, 154.09, 183.99, 153.88)), align="lr")
...
This is likely because fuel is an *inelastic* good, meaning that changes in prices do not significantly affect demand. It's a difficult product to substitute -- if you have a car, what else would you fuel it with? -- and is necessary for daily transportation. 
